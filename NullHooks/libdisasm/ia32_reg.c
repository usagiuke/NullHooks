...
static struct {
	...
	char mnemonic[8];
		...
		{ 0, (enum x86_reg_type)0, 0, "" },
	/* REG_DWORD_OFFSET */
		{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_gen | reg_ret), 0, "eax" },
		{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_gen | reg_count), 0, "ecx" },
	{ REG_DWORD_SIZE, reg_gen, 0, "edx" },
	{ REG_DWORD_SIZE, reg_gen, 0, "ebx" },
	/* REG_ESP_INDEX */
	{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_gen | reg_sp), 0, "esp" },
	{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_gen | reg_fp), 0, "ebp" },
	{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_gen | reg_src), 0, "esi" },
	{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_gen | reg_dest), 0, "edi" },
	/* REG_WORD_OFFSET */
	{ REG_WORD_SIZE, (enum x86_reg_type)(reg_gen | reg_ret), 3, "ax" },
	{ REG_WORD_SIZE, (enum x86_reg_type)(reg_gen | reg_count), 6, "cx" },
	{ REG_WORD_SIZE, reg_gen, 9, "dx" },
	{ REG_WORD_SIZE, reg_gen, 12, "bx" },
	{ REG_WORD_SIZE, (enum x86_reg_type)(reg_gen | reg_sp), 13, "sp" },
	{ REG_WORD_SIZE, (enum x86_reg_type)(reg_gen | reg_fp), 14, "bp" },
	{ REG_WORD_SIZE, (enum x86_reg_type)(reg_gen | reg_src), 15, "si" },
	{ REG_WORD_SIZE, (enum x86_reg_type)(reg_gen | reg_dest), 16, "di" },
	/* REG_BYTE_OFFSET */
	...
	/* REG_FPCTRL_INDEX  : 82*/
	{ REG_FPCTRL_SIZE, (enum x86_reg_type)(reg_fpu | reg_sys), 0, "fpctrl" },
	/* REG_FPSTATUS_INDEX : 83*/
	{ REG_FPSTATUS_SIZE, (enum x86_reg_type)(reg_fpu | reg_sys), 0, "fpstat" },
	/* REG_FPTAG_INDEX : 84 */
	{ REG_FPTAG_SIZE, (enum x86_reg_type)(reg_fpu | reg_sys), 0, "fptag" },
	/* REG_EIP_INDEX : 85 */
	...
	{ REG_DWORD_SIZE, (enum x86_reg_type)(reg_sys | reg_simd), 0, "mxcsr" },
